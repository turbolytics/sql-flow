...
docker exec -it kafka1 kafka-topics --bootstrap-server localhost:9092 --delete --topic input-simple-agg-mem || true

# Publish benchmark data set
python3 cmd/publish-test-data.py --num-messages=$NUM_MESSAGES --topic="input-simple-agg-mem"
