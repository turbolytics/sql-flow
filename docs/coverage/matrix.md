...
| `sink.clickhouse` | Inserts result batches into a ClickHouse table. | ✅ | ✅ | ✅ | 29 |
...
**32 invariants declared: 28 safety and 4 liveness. Of 136 (invariant, integration) cells: 29 proven, 87 missing, 0 skipped, 0 failing, 20 exempt. 0 gap(s).**
